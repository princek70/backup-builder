    ...
    <div className="w-full flex-1 flex bg-white font-sans text-sm p-8 pb-0">
        ...
        <div className="mb-8 resume-section">
          ...
          <ul className="space-y-2">
            {skills.map((skill, index) => (
              <li key={index} className="flex items-center gap-2 text-sm item">
      ...
      <div className="w-[65%] flex flex-col pt-4">
        ...
        <div className="flex items-center gap-8 mb-10 h-32 relative">
           ...
           <div className={`bg-[#ebeceb] py-6 px-10 rounded-r-full flex-1 relative w-full ${(resumeData.activeTemplateId !== 'template4' && (resumeData?.profileImage || personalInfo?.avatarUrl)) ? 'ml-16 left-10 pl-24' : 'ml-0'}`}>
        ...
        {/* About Me */}
        <div className="mb-8 pl-12 resume-section">
        ...
        {sections.map(section => (
          <div key={section.id} className="mb-8 pl-12 resume-section">
